...
export const metadata: Metadata = {
  title: "UGC Content Creation & User-Generated Marketing | UGC Creators",
  description: "Professional user-generated content creation for brands. Authentic UGC videos that convert. Trusted by leading companies for social media marketing.",
  keywords: "UGC, user-generated content, content creation, social media marketing, authentic content, video production",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    ...
    description: "Professional user-generated content creation services for brands. Increase engagement and drive conversions with authentic content.",
    type: "website",
    siteName: "UGC Creators",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1765795715003-0bygv185.jpg",
      alt: "UGC content creation showcase"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Authentic UGC Content That Converts",
    description: "Professional user-generated content creation for your brand",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1765795715003-0bygv185.jpg"]
  }
};
